...
#Sch name = JA8                                     ENB
set_property PACKAGE_PIN K2 [get_ports {enableB}]
set_property IOSTANDARD LVCMOS33 [get_ports {enableB}]
##Sch name = JA9
set_property PACKAGE_PIN H2 [get_ports {compA}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {compA}]
##Sch name = JA10
set_property PACKAGE_PIN G3 [get_ports {compB}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {compB}]
...
##Sch name = JB4 (aiming servo)
set_property PACKAGE_PIN B16 [get_ports {aim_servo}]
set_property IOSTANDARD LVCMOS33 [get_ports {aim_servo}]
##Sch name = JB7
...
##Sch name = JB10 (firing servo)
set_property PACKAGE_PIN C16 [get_ports {fire_servo}]					
set_property IOSTANDARD LVCMOS33 [get_ports {fire_servo}]



##Pmod Header JC
##Sch name = JC1
set_property PACKAGE_PIN K17 [get_ports {blue_LED}]
set_property IOSTANDARD LVCMOS33 [get_ports {blue_LED}]
##Sch name = JC2
set_property PACKAGE_PIN M18 [get_ports {red_LED}]
